 ...
 **************************************************************/
  ...
  *      rotation, transposition, horizontal and vertical flipping) to a 
  *      Pnm_ppm image. 
  *
  * Parameters:
  ...
  *        dimensions of the original image and the type of transformation to 
  *        be performed.
                                                           ...
                                                           A2Methods_T methods)
 {
         ...
         /* 
          * Changes the dimensions of the destination array if required based 
  ...
  * Notes:
  *      - 
  *      - Handles various command-line options for transformations and 
  *        methods.
